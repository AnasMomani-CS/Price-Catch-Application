...
class CenterWidget extends StatelessWidget {
  final Size size;
  final Color color1; // لون أول (ديناميك)
  final Color color2; // لون ثاني (ديناميك)
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        CustomPaint(painter: CenterWidgetPainter(path: path)),
        ClipPath(
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    color1.withOpacity(0.5), // تعديل
                    color2.withOpacity(0.3), // تعديل
                  ],
                ),
              ),
            ),
